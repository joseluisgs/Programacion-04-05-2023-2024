 ...
 */
class Configuation private constructor(val mapSize: Int = 5, val numberOfEnemies: Int = 15, val time: Int = 30) {
    ...
    companion object {
        ...
        fun fromArgs(args: Array<String>): Configuation {
            ...
            if (mapSize !in (5..9) || numberOfEnemies !in (5..30) || time !in (1..30)) {
                showErrorMessage()
            }
